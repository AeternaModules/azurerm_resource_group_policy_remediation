...
EOT
  ...
  # --- Unconfirmed validation candidates, derived from azurerm_resource_group_policy_remediation's provider source ---
  ...
  # path: resource_group_id
  #   source:    [from resourceValidate.ResourceGroupID] !ok
  # path: resource_group_id
  #   source:    [from resourceValidate.ResourceGroupID] err != nil
