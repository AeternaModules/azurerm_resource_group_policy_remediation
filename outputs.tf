output "resource_group_policy_remediations_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.id }
}
output "resource_group_policy_remediations_failure_percentage" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.failure_percentage }
}
output "resource_group_policy_remediations_location_filters" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.location_filters }
}
output "resource_group_policy_remediations_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.name }
}
output "resource_group_policy_remediations_parallel_deployments" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.parallel_deployments }
}
output "resource_group_policy_remediations_policy_assignment_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.policy_assignment_id }
}
output "resource_group_policy_remediations_policy_definition_reference_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.policy_definition_reference_id }
}
output "resource_group_policy_remediations_resource_count" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_count }
}
output "resource_group_policy_remediations_resource_discovery_mode" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_discovery_mode }
}
output "resource_group_policy_remediations_resource_group_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_group_id }
}
