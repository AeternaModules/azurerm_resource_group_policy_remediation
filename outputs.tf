output "resource_group_policy_remediations_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.id if v.id != null && length(v.id) > 0 }
}
output "resource_group_policy_remediations_failure_percentage" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.failure_percentage if v.failure_percentage != null }
}
output "resource_group_policy_remediations_location_filters" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.location_filters if v.location_filters != null && length(v.location_filters) > 0 }
}
output "resource_group_policy_remediations_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.name if v.name != null && length(v.name) > 0 }
}
output "resource_group_policy_remediations_parallel_deployments" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.parallel_deployments if v.parallel_deployments != null }
}
output "resource_group_policy_remediations_policy_assignment_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.policy_assignment_id if v.policy_assignment_id != null && length(v.policy_assignment_id) > 0 }
}
output "resource_group_policy_remediations_policy_definition_reference_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.policy_definition_reference_id if v.policy_definition_reference_id != null && length(v.policy_definition_reference_id) > 0 }
}
output "resource_group_policy_remediations_resource_count" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_count if v.resource_count != null }
}
output "resource_group_policy_remediations_resource_discovery_mode" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_discovery_mode if v.resource_discovery_mode != null && length(v.resource_discovery_mode) > 0 }
}
output "resource_group_policy_remediations_resource_group_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_remediation.resource_group_policy_remediations : k => v.resource_group_id if v.resource_group_id != null && length(v.resource_group_id) > 0 }
}
